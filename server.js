...
SpringRubberSetting=0//Detached (Fixed)
RideHeightSetting=15//7.5 cm (Min: 0, Max: 30)
SlowBumpSetting=4//14 (Min: 0, Max: 10)
FastBumpSetting=4//14 (Min: 0, Max: 10)
SlowReboundSetting=6//11 (Min: 0, Max: 10)
FastReboundSetting=6//11 (Min: 0, Max: 10)
BrakeDiscSetting=0//4.00 cm (Fixed)
BrakePadSetting=0//1 (Fixed)
CompoundSetting=0//82% Soft (Min: 0, Max: 2)
...
## 5.5. **Tune [BASIC] Parameters:** Based on the above decisions, dynamically adjust the Downforce, Balance, Ride, and Gearing values in the [BASIC] section (0.000000 to 1.000000 scale).
##    - **Downforce:** Higher for high-downforce tracks / aggressive setups; Lower for low-drag tracks.
##    - **Balance:** Reflect overall aero/mechanical balance (e.g., <0.5 for oversteer tendency, >0.5 for understeer tendency).
##    - **Ride:** Lower for smooth tracks/aero performance; Higher for bumpy tracks/compliance.
##    - **Gearing:** Set close to 1.000000 for very long gears (high-speed tracks); Close to 0.000000 for short gears (technical/accelerative tracks).
